...
export function ProjectsSection({
  ...
  return (
    <section id="portfolio" className="py-32 px-6 md:px-12 bg-slate-950 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-indigo-500 opacity-[0.03] blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div 
          ref={scrollRef}
          className="flex overflow-x-auto gap-8 pb-12 pt-4 snap-x snap-mandatory scrollbar-none scroll-smooth"
        >
