...
export function ContactSection({
  ...
  return (
    <section id="contact" className="py-32 px-6 md:px-12 bg-slate-950 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <div className="mt-16 space-y-10">
              {[
                { icon: Mail, label: "Email Us", value: "hello@karmakoders.ai" },
            ...
            >
              <a href="#" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-indigo-500 hover:text-slate-950 hover:border-indigo-500 hover:scale-110 hover:shadow-indigo-500/40 transition-all duration-300">
