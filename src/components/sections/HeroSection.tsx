...
export function HeroSection({
  ...
  return (
    <section id="hero" className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 pt-32 text-center md:text-left flex flex-col items-center md:items-start">
        ...
        {/* Stats row */}
        <motion.div 
          className="flex flex-wrap justify-center md:justify-start gap-10 md:gap-16 mt-24 pt-10 border-t border-white/5 w-full"
